...
## Step 1 Problem Framing (Colleague Brief)

I’m starting a focused empirical workflow on **algorithmic pricing and demand elasticity in app-based grocery delivery**. My Step 1 goal is to lock the question, estimand, and identification path before touching model-heavy analysis.
...
My Step 1 framing therefore prioritizes **identification first**:
...
By end of Step 1, I will deliver:
...
If we align on these inputs today, I can move into Step 2 extraction and Step 3 baseline estimation with minimal rework.
