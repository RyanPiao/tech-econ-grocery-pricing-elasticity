# Week 2 Day 1 Problem Framing (Colleague Brief)

## Purpose
Week 1 validated the workflow on synthetic data. Week 2 starts by locking the production-facing design decisions needed to convert that workflow into a stronger causal evidence package.

Today’s Day 1 objective is to remove ambiguity in four areas before additional modeling:
...
## What we are trying to learn in Week 2
...
### 4) Medium-run retention/frequency outcomes
- Lock outcome windows for repeat behavior analysis (user-day/user-week panel).
...
Without these Day 1 locks, Week 2 risks producing non-comparable estimates and post-hoc specification drift. Locking extraction lineage, dynamic diagnostics, segment definitions, and horizon outcomes up front protects credibility and speeds downstream execution.

## Day 1 deliverables
- `docs/week2_PLAN.md` (execution plan and success criteria)
- `docs/week2_DAY1_problem_framing.md` (this memo)
- README update adding a dedicated **Week 2 focus** section
