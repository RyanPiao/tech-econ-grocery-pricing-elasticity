# Week 2 Plan — Production Extraction and Causal-Readiness Extensions

## Context
Week 1 delivered a reproducible synthetic pipeline and a baseline econometric workflow. The immediate Week 2 goal is to migrate the design to production-grade inputs and close the highest-priority evidence gaps documented in `docs/day7_weekly_recap.md` and `docs/day5_limitations.md`.
...
**Day 4–5 tasks**
- Build user-day (or user-week) outcome panel linked to treatment exposure.
...
## Day 1 focus (this handoff)
Day 1 of Week 2 is a framing and lock day. Immediate objective is to finalize:
...
Detailed Day 1 framing memo: `docs/week2_DAY1_problem_framing.md`.
