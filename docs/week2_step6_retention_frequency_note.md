# Week 2 Day 6 — Medium-Run Retention/Frequency Outcomes

## Objective
Estimate whether higher current-week delivered prices predict weaker medium-run activity.

## Panel construction
- Build user-week panel from contamination-excluded sessions
- Per user-week metrics:
  - `sessions`
  - `orders`
...
- Controls: current week orders/sessions + ops controls
- Fixed effects: market + week
